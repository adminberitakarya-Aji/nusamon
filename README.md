...
| Prototipe World/Catch (Fase 2) | 🔨 **Berjalan** — inventori & toko Amukan + tim/partai (maks. 6, tangkap masuk tim, EXP persisten) + switch mon saat battle + **Nusadex** (lihat/tangkap, daftar + detail, deskripsi 30 spesies) selesai; berikutnya: ability engine, Latihan EV-lite, save/load |
